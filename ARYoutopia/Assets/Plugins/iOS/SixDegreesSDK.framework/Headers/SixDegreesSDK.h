...
/*!
 @brief Populates versionOut with the current version number of the SDK, e.g. "0.20.0"
...
enum SixDegreesState {
    ...
    //! The SDK is intialized and running
 ...
 */
API_METHOD void SixDegreesSDK_SaveToARCloud(void);

/*!
 @brief Interrupts and cancels the current SaveToARCloud process.
 */
API_METHOD void SixDegreesSDK_CancelSave(void);
 ...
 */
API_METHOD void SixDegreesSDK_GetSaveStatus(int* stateOut, int* errorOut, long int* timestampOut);
 ...
 */
API_METHOD void SixDegreesSDK_LoadFromARCloud(void);

/*!
 @brief Interrupts and cancels the current LoadFromARCloud process.
 */
API_METHOD void SixDegreesSDK_CancelLoad(void);
...
/*!
 ...
 @param timestampOut optional pointer to the timestamp value.
 */
API_METHOD void SixDegreesSDK_GetLoadStatus(int* stateOut, int* errorOut, long int* timestampOut);
 ...
 */
API_METHOD int SixDegreesSDK_GetMeshBlockInfo(int* blockBufferSizeOut, int* vertexBufferSizeOut, int* faceBufferSizeOut);
 ...
 */
API_METHOD int SixDegreesSDK_GetMeshBlocks(int* blockBuffer, float* vertexBuffer, int* faceBuffer, int blockBufferSize, int vertexBufferSize, int faceBufferSize);
